    ...
    <main className="px-4 sm:px-6 lg:px-12 xl:px-20">
      ...
      <section className="mx-auto max-w-7xl space-y-5 lg:space-y-6">
        {topics.map((t, i) => (
          <article
            key={i}
            className="flex w-full flex-col items-start gap-4 rounded-xl border border-neutral-200 bg-white p-5 shadow-sm ring-1 ring-black/0 transition-colors hover:border-neutral-300 sm:flex-row sm:items-center sm:gap-6 sm:p-6 md:gap-8 md:p-8"
          >
            {/* Left icon */}
            <div className="flex h-16 w-16 flex-shrink-0 items-center justify-center rounded-lg bg-neutral-50 sm:h-20 sm:w-20 md:h-24 md:w-24 lg:h-28 lg:w-28">
              <Image
                src="/logo.png"
                alt="Dharma wheel"
                width={96}
            ...
            <div className="flex flex-1 flex-col">
              ...
              <div className="mt-3">
                <button
                  className="rounded-md border border-neutral-200 bg-neutral-100 px-3 py-1 text-xs sm:px-4 sm:py-2 sm:text-sm md:px-5 md:py-2 md:text-base text-neutral-700 hover:bg-neutral-200"
                  type="button"
                >
                  Button
                </button>
